...
public class StudentActivity extends AppCompatActivity {
    ...
    private class DataSyncTask extends AsyncTask<StudentList,Void,StudentArrayAdapter>{
        ...
        @Override
        protected StudentArrayAdapter doInBackground(StudentList... studentLists) {
            StudentArrayAdapter studentAdapter = new StudentArrayAdapter(getApplicationContext(),studentLists[0]);
